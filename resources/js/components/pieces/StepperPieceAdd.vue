    ...
    >
        ...
        <tab-content title="Sous-compartiments">
            <div class="container">
                ...
                <!-- utiliser vuescroll ici -->
                <vuescroll :ops="options">
                    <div class="row">
                        <div class="col-md-1"></div>
                        <div style="margin-top:10px" class="row col-md-10">
                            <div
                                v-for="scategorie in scategories"
                                :key="scategorie.id"
                                class="col-md-3"
                            >
                                <figure
                                    @click="selectScategorie(scategorie.id)"
                                    class="figure"
                                >
                                    <img
                                        class="figure-img img-fluid rounded image"
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            />
                            <span
                                v-if="messages.prix_achat.exist"
                                class="text-danger"
                            >
                        ...
                        <div class="form-group">
                            ...
                            />
                            <span
                                v-if="messages.prix_vente.exist"
                                class="text-danger"
                            >
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="t2"
                                    >Pièce d'origine</label
                                >
                            </div>
                            <span
                                v-if="messages.type_piece.exist"
                                class="text-danger"
                            >
...
export default {
    ...
    methods: {
        ...
        complete() {
            axios
                .post("/stock/piece/store", {
                    ...
                    magasin: this.piece.magasin
                        ? this.piece.magasin.code
                        : null,
                ...
                .then(result => {
                    this.$bvModal
                        .msgBoxConfirm(
                            "Voulez vous créer une autre pièce de vehicule ?",
                            {
                        ...
                        .then(value => {
                            value
                                ? location.reload()
                                : (location.href = "/stock/piece/liste");
                        })
                        .catch(err => {});
                })
                .catch(err => {
                    ...
                    if (errors.type_vehicule) {
                        ...
                        this.messages.type_vehicule.value =
                            errors.type_vehicule[0];
                    }
                    if (errors.annee) {
        ...
        selectCategorie(id) {
            ...
            this.scategories = this.scategories.filter(
                scategorie => scategorie.categorie === id
            );
        },
        selectScategorie(id) {
            this.scategorie = id;
