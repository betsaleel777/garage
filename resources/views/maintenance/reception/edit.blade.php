                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="enjoliveur" id="en1" value="AVG"
                                          @if ($reception->vehicule->enjoliveur === 'AVG')
                                       checked
                                       @endif>
                                    ...
                                    <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="enjoliveur" id="en2" value="AVD"
                                          @if ($reception->vehicule->enjoliveur === 'AVD')
                                       checked
                                       @endif>
                                    ...
                                    <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="enjoliveur" id="en3" value="ARG"
                                          @if ($reception->vehicule->enjoliveur === 'ARG')
                                       checked
                                       @endif>
                                    ...
                                    <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="enjoliveur" id="en4" value="ARD"
                                          @if ($reception->vehicule->enjoliveur === 'ARD')
                                       checked
                                       @endif>
                                 ...
                                 <div class=" form-group row">
                                    <div class="col-4">
                                       ...
                                       <input value="{{ $reception->vehicule->marque }}" name="marque" id="marque"
                                          type="text" class="form-control" placeholder="audi">
                                       @error('marque')
                                          <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                    </div>
                                    <div class="col-3">
                                       ...
                                       <input value="{{ $reception->vehicule->modele }}" name="modele" id="modele"
                                          type="text" class="form-control" placeholder="A6">
                                       @error('modele')
                                          <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input value="{{ $reception->vehicule->dmc }}" name="dmc" class="form-control"
                                       id="dmc" />
                                    @error('dmc')
                                       <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="niveau_carburant" id="ca1"
                                          value="0" @if ($reception->vehicule->niveau_carburant === '0')
                                       checked
                                       @endif>
                                    ...
                                    <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="niveau_carburant" id="ca4"
                                          value="3/4" @if ($reception->vehicule->niveau_carburant === '1')
                                       checked
                                       @endif>
                                    ...
                                    <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="niveau_carburant" id="ca5"
                                          value="1" @if ($reception->vehicule->niveau_carburant === '1')
                                       checked
                                       @endif>
