            ...
            <div class="row mb-2">
               ...
               <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                     <li class="breadcrumb-item"><a href="{{ route('reparations') }}">Tableau Réparations</a></li>
                     <li class="breadcrumb-item"><a href="{{ route('reparation_liste') }}">Liste Réparations</a></li>
            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  <div class="card card-primary collapsed-card">
                     ...
                     <!-- /.card-header -->
                     <div class="card-body">
                        <old-intervention :interventions="{{ $interventions_diagnostique }}"></old-intervention>
                        {{-- panne --}}
                        <div class="alert alert-success" role="alert">
                           <h4 class="alert-heading">Panne Trouvée!</h4>
                           <p>
                              {{ $reception->diagnostique->panne }}
                           </p>
                           <hr />
                           <p class="mb-0">
                              Le délais provisoire estimé pour la réparation est de:
                              {{ $reception->diagnostique->temps_estime }}
                           </p>
                           <div style="text-align: right">
                              <small
                                 class="text-muted"><b>{{ $reception->diagnostique->updated_at->diffForHumans(['parts' => 3, 'short' => true]) }}</b></small>
                           </div>
                        </div>
                     </div>
                     <!-- /.card-body -->
               ...
               {{-- formulaire intervention réparations --}}
               <div class="col-md-12">
                  <form-reparation :reparation="{{ $reception->reparation->id }}" :ateliers="{{ $ateliers }}"
                     :reception="{{ $reception->id }}"></form-reparation>
               </div>
            </div>
            <!-- /.row -->
