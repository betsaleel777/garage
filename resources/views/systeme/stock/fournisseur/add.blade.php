            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form method="post" action="{{ route('fournisseur_store') }}" role="form">
                           @csrf
                           ...
                           <div class="form-group">
                              ...
                              <input value="{{ old('contact') }}" name="contact" class="form-control" id="contact">
                              @error('contact')
                                 <span class="text-danger"> {{ $message }}</span>
                              @enderror
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <input value="{{ old('siege') }}" name="siege" class="form-control" id="siege">
                              @error('siege')
                                 <span class="text-danger"> {{ $message }}</span>
                              @enderror
                           </div>
