   ...
   <div class="content-wrapper">
      ...
      <div class="content-header">
         <div class="container-fluid">
            <div class="row mb-2">
               <div class="col-sm-6">
                  <h1 class="m-0 text-dark">Catégorie: {{ $categorie->nom }}</h1>
               </div><!-- /.col -->
               <div class="col-sm-6">
            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form enctype="multipart/form-data" method="post" action="{{ route('categorie_update') }}"
                           role="form">
                           @csrf
                           <input hidden name="categorie" type="text" value="{{ $categorie->id }}">
                           <div class="form-group">
                              <label for="nom">Nom complet</label>
                              <input value="{{ $categorie->nom }}" name="nom" class="form-control" id="nom">
                              @error('nom')
                           ...
                           <div class="row">
                              <div class="col-md-3 form-group">
                                 ...
                                 @else
                                    <img width="200" src="{{ url('storage/' . $categorie->image) }}"
                                       alt="{{ $categorie->image }}">
                                 @endempty
                              </div>
