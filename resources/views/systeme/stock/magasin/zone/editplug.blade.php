   ...
   <div class="content-wrapper">
      ...
      <div class="content-header">
         <div class="container-fluid">
            <div class="row mb-2">
               <div class="col-sm-6">
                  <h1 class="m-0 text-dark">Modifier {{ $zone->nom }}</h1>
               </div><!-- /.col -->
               <div class="col-sm-6">
            ...
            <div class="row">
               ...
               <div class="col-md-8">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form method="post" action="{{ route('zone_update_plug') }}" role="form">
                           @csrf
                           <input name="zone" hidden type="text" value="{{ $zone->id }}">
                           ...
                           <div class="form-group">
                              ...
                              <input value="{{ $zone->identifiant }}" name="identifiant" class="form-control"
                                 id="ident">
                              @error('identifiant')
                                 <span class="text-danger">{{ $message }}</span>
                              @enderror
