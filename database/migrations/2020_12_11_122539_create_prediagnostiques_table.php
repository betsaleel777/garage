...
class CreatePrediagnostiquesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prediagnostiques', function (Blueprint $table) {
            $table->id();
            ...
            $table->longText('etat_radiateur')->nullable();
    ...
    {
        Schema::dropIfExists('prediagnostiques');
    }
}
